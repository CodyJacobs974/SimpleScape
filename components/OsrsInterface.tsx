...
const OsrsInterface: React.FC<OsrsInterfaceProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Top Tabs */}
      <div className="absolute top-[171px] left-[532px] w-[218px] flex flex-wrap gap-x-[4px]" role="tablist" aria-label="Main Menu">
        {topTabs.map(tab => (
      ...
      {/* Bottom Tabs */}
      <div className="absolute top-[478px] left-[532px] w-[218px] flex flex-wrap gap-x-[4px]" role="toolbar" aria-label="Utility Buttons">
        {bottomTabs.map(tab => (
